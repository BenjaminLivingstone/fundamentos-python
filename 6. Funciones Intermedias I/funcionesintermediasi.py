...
# Aquí hay un par de notas importantes sobre el uso de random.random () y round(). 
...
# Aquí hay un poco de código para comenzar, con algunos casos de prueba y resultados esperados. 
# Prueba cada llamada de función una a la vez y varias veces cada una para asegurarse de obtener el rango correcto.
